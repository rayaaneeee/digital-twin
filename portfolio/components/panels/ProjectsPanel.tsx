...
const PROJECTS = [
  ...
  },
  {
    ...
    emoji: '🌐',
    tagline: 'ML · Network Security',
    description: 'ML pipeline classifying DNS traffic as tunneling or legitimate. Random Forest, XGBoost, Logistic Regression evaluated with ROC curves and feature-importance analysis.',
